...
//   const selectedRoomSlug = searchParams.room;

//   const allCollectionRooms = rooms.flatMap((room) => room.collection);

//   const selectedRoom = allCollectionRooms.find((room) => room.slug === selectedRoomSlug);
...
//           <h2 className="text-3xl">{selectedRoom.title}</h2>
//           <p className="mt-2 text-white/60">{selectedRoom.description}</p>
//           <p className="mt-4 text-[#D4AF37]">From {selectedRoom.price} / Night</p>
//         </div>
//       )}
//     </main>
//   );
